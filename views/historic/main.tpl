...
<nav id="menu">
	...
	{/if}
	<ul>
		<li><a href="{$ustawienia.base_url}" title="{$tlumaczenia_teksty.menu_glowna}" {if $strona=='index'}class="active"{/if}>{$tlumaczenia_teksty.menu_glowna}</a></li>
		...
		<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.dodaj}" title="{$tlumaczenia_teksty.menu_dodaj}" {if $strona=='dodaj'}class="active"{/if}>{$tlumaczenia_teksty.menu_dodaj}</a></li>
		{if $ustawienia.tworzenie==1}<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.stworz}" title="{$tlumaczenia_teksty.menu_stworz}" {if $strona=='stworz'}class="active"{/if}>{$tlumaczenia_teksty.menu_stworz}</a></li>{/if}
		{if isset($uzytkownik)}
			<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.konto}" title="{$tlumaczenia_teksty.menu_konto}" {if $strona=='konto'}class="active"{/if}>{$tlumaczenia_teksty.menu_konto}</a></li>
