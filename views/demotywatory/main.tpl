...
<nav id="menu">
	...
	{/if}
	<ul>
		<li><a href="{$ustawienia.base_url}" title="{$tlumaczenia_teksty.menu_glowna}" {if !isset($smarty.get.akcja) || $smarty.get.akcja==''}class="active"{/if}>{$tlumaczenia_teksty.menu_glowna}</a></li>
		<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.poczekalnia}" title="{$tlumaczenia_teksty.menu_poczekalnia}" {if isset($smarty.get.akcja) && $smarty.get.akcja=={$tlumaczenia_linki.poczekalnia}}class="active"{/if}>{$tlumaczenia_teksty.menu_poczekalnia}</a></li>
		{if isset($kategorie)}
			<li><a href="{$ustawienia.base_url}" title="{$tlumaczenia_teksty.menu_kategorie}" id="menu_kategorie"  {if isset($smarty.get.akcja) && $smarty.get.akcja=={$tlumaczenia_linki.kategoria}}class="active"{/if}>{$tlumaczenia_teksty.menu_kategorie} +</a>
				<ul>
					<div id="menu_scroll">
		...
		{/if}		
		<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.top}" title="{$tlumaczenia_teksty.menu_top}" {if isset($smarty.get.akcja) && $smarty.get.akcja=={$tlumaczenia_linki.top}}class="active"{/if}>{$tlumaczenia_teksty.menu_top}</a></li>
		<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.dodaj}" title="{$tlumaczenia_teksty.menu_dodaj}" {if isset($smarty.get.akcja) && $smarty.get.akcja=={$tlumaczenia_linki.dodaj}}class="active"{/if}>{$tlumaczenia_teksty.menu_dodaj}</a></li>
		{if $ustawienia.tworzenie==1}<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.stworz}" title="{$tlumaczenia_teksty.menu_stworz}" {if isset($smarty.get.akcja) && $smarty.get.akcja=={$tlumaczenia_linki.stworz}}class="active"{/if}>{$tlumaczenia_teksty.menu_stworz}</a></li>{/if}
		{if isset($uzytkownik)}
			<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.konto}" title="{$tlumaczenia_teksty.menu_konto}" {if isset($smarty.get.akcja) && $smarty.get.akcja=={$tlumaczenia_linki.konto}}class="active"{/if}>{$tlumaczenia_teksty.menu_konto}</a></li>
