...
<nav id="menu">
	...
	<ul>
		...
		{if $ustawienia.mapa_uzytkownikow==1}<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.mapa_uzytkownikow}" title="{$tlumaczenia_teksty.menu_mapa_uzytkownikow}">{$tlumaczenia_teksty.menu_mapa_uzytkownikow}</a></li>{/if}
		...
		{if $ustawienia.tworzenie==1}<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.stworzone}" title="{$tlumaczenia_teksty.menu_stworzone}">{$tlumaczenia_teksty.menu_stworzone}</a></li>{/if}
		<li><a href="{$ustawienia.base_url}/{$tlumaczenia_linki.uzytkownicy}" title="{$tlumaczenia_teksty.menu_uzytkownicy}">{$tlumaczenia_teksty.menu_uzytkownicy}</a></li>
		{if isset($uzytkownik)}
