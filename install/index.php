...
?>');		
			...
			mysql_query("CREATE TABLE IF NOT EXISTS `cms_logi` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `login` varchar(256) COLLATE utf8_polish_ci DEFAULT NULL,  `zalogowal` int(11) DEFAULT NULL,  `data` datetime DEFAULT NULL,  `ip` varchar(256) COLLATE utf8_polish_ci DEFAULT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci AUTO_INCREMENT=1 ;");
			mysql_query("CREATE TABLE IF NOT EXISTS `glosy` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `obrazek_id` int(11) NOT NULL,  `glos` int(1) NOT NULL,  `autor_id` int(11) NOT NULL,  `ip` varchar(32) COLLATE utf8_polish_ci NOT NULL,  `data` datetime NOT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci AUTO_INCREMENT=1 ;");
			...
			mysql_query("CREATE TABLE `komentarze_glosy` ( `id` INT NOT NULL AUTO_INCREMENT , `komentarz_id` INT NOT NULL , `glos` INT(1) NOT NULL , `autor_id` INT NOT NULL , `ip` VARCHAR(32) NOT NULL , `data` DATETIME NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
